    ...
    <body>
        ...
        <%
            ...
            String tables[] = new String[] {
                "CREATE TABLE ROOM (ROOM_ID INTEGER NOT NULL, DESCRIPTION VARCHAR(400) NOT NULL, ADREÇA VARCHAR(400) NOT NULL,CITY VARCHAR(25), PRICE DECIMAL(8, 4),SIMPLE_ROOM BOOLEAN, INDOOR BOOLEAN, FURNISHED BOOLEAN, ZIPCODE INTEGER NOT NULL,PRIMARY KEY (ROOM_ID))",
                "CREATE TABLE TENANT (ID INTEGER NOT NULL, SMOKER BOOLEAN, PET BOOLEAN,NAME VARCHAR(20) NOT NULL, SURNAME VARCHAR(20) NOT NULL,USERNAME VARCHAR(20) NOT NULL, PASSWORD VARCHAR(20) NOT NULL,SEX VARCHAR(20) NOT NULL, AGE INTEGER NOT NULL,EMAIL VARCHAR(20) NOT NULL,PRIMARY KEY (ID))",
                "CREATE TABLE RENTER (ID INTEGER NOT NULL, NAME VARCHAR(10) NOT NULL, SURNAME VARCHAR(10) NOT NULL, ADREÇA VARCHAR(400) NOT NULL, CITY VARCHAR(20) NOT NULL, EMAIL VARCHAR(30) NOT NULL, SMOKER BOOLEAN, PET BOOLEAN, AGE_MAX INTEGER NOT NULL, AGE_MIN INTEGER NOT NULL,ZIP INTEGER NOT NULL,PRIMARY KEY (ID))",
            ...
            */
            ...
            String data[] = new String[]{
                "INSERT INTO ROOM VALUES (1, 'Habitacio gran i neta al centre de Reus.', 'Carrer monestir de poblet num28','Reus', 900.00, TRUE, FALSE, TRUE, 43205)",
                "INSERT INTO ROOM VALUES (2, 'Habitacio ambientada en del estil japones.', 'Carrer ripoll a les afores de Reus','Reus', 400.00, FALSE, FALSE, TRUE, 43206)",
                "INSERT INTO ROOM VALUES (3, 'Habitacio en un gratacels de dubai on es veu la posta de sol', 'Avinguda de dubai falsa','Dubai', 1000.66, FALSE, FALSE, FALSE, 90205)",
                "INSERT INTO ROOM VALUES (4, 'Habitacio petita de 40m2 a cambrils.', 'Riera de cambrils','Cambrils', 200.45, TRUE, TRUE, TRUE, 43205)",

                "INSERT INTO TENANT VALUES(1, TRUE, TRUE,'sob', 'sob','sob', 'sob','unisex', 20, 'sob@gmail.com')",
                "INSERT INTO TENANT VALUES(2, FALSE, TRUE,'Joan', 'Jara','jarita45', '123456','home', 23, 'joan.jara@gmail.com')",
                "INSERT INTO TENANT VALUES(3, TRUE, FALSE,'Aleix', 'Iglesias','maricarmen89', '123456','dona', 50, 'maricarmen@gmail.com')",
                "INSERT INTO TENANT VALUES(4, FALSE, FALSE,'Marc', 'Ferrer','capdesuro', '123456','home', 70, 'marcferrer@gmail.com')",
                "INSERT INTO TENANT VALUES(5, TRUE, TRUE,'Antonio', 'Giro','Antonito76', 'antomito_890','unisex', 20, 'antonio@gmail.com')",
          
                "INSERT INTO RENTER VALUES(1, 'Aleix', 'Mariner', 'Cambrils, carrer tenenant', 'Cambrils', 'aleix.mariner@gmail.com', TRUE, TRUE, 50, 18,45900)",
                "INSERT INTO RENTER VALUES(2, 'Mario', 'Bros', 'Carrer dels morts', 'Reus', 'fals1@gmail.com', TRUE, FALSE, 50, 23,34567)",
                "INSERT INTO RENTER VALUES(3, 'Luigi', 'Bros', 'Carrer pedrastela', 'Reus', 'fals2@gmail.com', FALSE, TRUE, 80, 18,43209)",
                "INSERT INTO RENTER VALUES(4, 'Esvalda', 'Antoniet', 'Avinguda diagonal', 'Dubai', 'fals3@gmail.com', FALSE, FALSE, 50, 50,50034)",
