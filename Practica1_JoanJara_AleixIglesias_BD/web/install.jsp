...
<html>
    ...
    <body>
        ...
        <%
            ...
            Connection con = DriverManager.getConnection("jdbc:derby://localhost:1527/" + dbname + ";create=true", "sob_grup_04", "sob_grup_04");
            ...
            String data[] = new String[]{
                "INSERT INTO " + dbname + ".CUSTOMER (CUSTOMER_ID, DISCOUNT_CODE, ZIP, \"NAME\", ADDRESSLINE1, ADDRESSLINE2, CITY, \"STATE\", PHONE, FAX, EMAIL, CREDIT_LIMIT) VALUES (1, 'N', '95117', 'Jumbo Eagle Corp', '111 E. Las Olivas Blvd', 'Suite 51', 'Fort Lauderdale', 'FL', '305-555-0188', '305-555-0189', 'jumboeagle@example.com', 100000)",
